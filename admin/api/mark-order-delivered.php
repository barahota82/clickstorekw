...
admin_require_permission_json('order.deliver', 'ليس لديك صلاحية لتحويل الطلب إلى Delivered');
...
try {
    ...
    admin_activity_log(
        ...
        'order',
        $orderId,
        'Marked order as completed | order number: ' . $orderNumber . ' | from status: ' . $currentStatus
    );
